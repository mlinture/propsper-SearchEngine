...
# This file is used for the TERMINAL version of our search engine
...
if __name__ == '__main__':
    ...
    while True:
        ...
        query = input('Enter what you would like to search for: ')
        ...
        print(f'Total elapsed time: {elapsed_time * 100} ms')
